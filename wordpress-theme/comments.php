...
<div id="comments" class="comments-area comments">
    ...
    <?php
        ...
        $fields =  array(
            'author' => '<div class="col-md-4"><input id="author" name="author" type="text" placeholder="Imię" value="" size="30"' . $aria_req . '/></div>',
        );
        ...
        $comments_args = array(
            ...
            'comment_notes_after'       => '',
            'comment_field'             => '<div class="clearfix"></div><div class="col-md-12"><textarea id="comment" placeholder="Treść komentarza" name="comment" aria-required="true"></textarea></div>',
            'label_submit'              => 'Dodaj'
        );
        ob_start();
